...
namespace Strata8.Wireless.Cdr.Reporting
{
    ...
    public class WirelessCdrProcessor1
    {
        // processing thread
            ...
            DateTime reportEndTime, DateTime reportStartTime, string emailList )
        {
            try
            {
                ...
                string To = emailList;
                StringBuilder header = new StringBuilder("OnWaves Call Statistics \n");
                ...
                string From = "OWCallReport@strata8.com";
                ...
                bod.Append(@"</tr>");
                bod.Append(@"<tr>");
                bod.Append(@"<td colspan=""17""><hr></td>");
                bod.Append(@"</tr> ");
                ...
                bod.Append(@"</tr> ");
                bod.Append(@"<tr> ");
                bod.Append(@"<td colspan=""1"" bgcolor=""CCFFCC"" align=""center""><font face=""verdana"" size=""1""><strong></strong></font></td>");
                ...
                foreach (OmcCdr s in sprintList)
                {
                    ...
                    bod.Append(@"<td bgcolor=""CCFFCC"" align=""center""><font face=""verdana"" size=""1"">" + s.Answer.Subtract(s.Seize).ToString() + "</font></td>");
            ...
            try
            {
                while (true)
                {
                    try
                    {
                        ...
                        if (t.TotalHours > 24)
                        {
                            DateTime reportFromTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 0, 0, 0).Subtract(ts);
        ...
        public static void PostFileToSite(string ftpSiteName, string user, string pass, string fileName)
        {
            try
            {
                string parsedFileName = WirelessCdrProcessor1.ParseFileName(fileName);
