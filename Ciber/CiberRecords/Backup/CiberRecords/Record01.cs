...
namespace Strata8.Wireless.Cdr.Ciber
{
    ...
    public class Record01
    {
        ...
        public Record01( )
        {
            ...
            this.BatchCreationDate = yy+mm+dd;
        ...
        public Record01( string line )
        {
            ...
            batchContents = line.Substring(35, 1);
            if ( line.Length >= 56 )
                localCarrierReserved = line.Substring(36, 20 );
            if ( line.Length == 200 )
                systemReservedFiller = line.Substring(56, 144 );
