...
namespace Strata8.Wireless.Cdr.Rating
{
    ...
    public class OmcCiberHandler
    {
        ...
        private string m_ciberDirectory;
        ...
        /// <summary>
        /// the watcher error to log the error for now
        /// </summary>
        ...
        private void WatcherError(object source, ErrorEventArgs e)
        {
            ...
            // let's log the error for now to see what is going on
            WriteToLogFile("OmcCiberHandler::WatcherError():ExceptionCaught:" + ex.ToString());
        ...
        public void StartProcessing()
        {
            ...
            {
                WriteToLogFile("OmcCiberHandler::StartProcessing():SecurityExceptionCaught:" + se.Message );           
            }
            ...
            try
            {
                ...
                OmcCiberHandler.m_watcher = new FileSystemWatcher(watchFolder, fileType);

                // Watch for changes in LastAccess and LastWrite times
                OmcCiberHandler.m_watcher.NotifyFilter = NotifyFilters.CreationTime | NotifyFilters.LastAccess | NotifyFilters.LastWrite;

                OmcCiberHandler.m_watcher.Created += new FileSystemEventHandler(this.ProcessFileWatcher);
                OmcCiberHandler.m_watcher.Changed += new FileSystemEventHandler(this.ProcessFileWatcher);
                OmcCiberHandler.m_watcher.Error += new ErrorEventHandler(WatcherError);

                OmcCiberHandler.m_watcher.EnableRaisingEvents = true;
            ...
            catch (Exception ex)
            {
                ...
                WriteToLogFile("OmcCiberHandler::StartProcessing():ExceptionCaught:" + ex.ToString());
