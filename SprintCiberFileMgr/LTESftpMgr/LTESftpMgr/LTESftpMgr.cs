...
namespace TruMobility.Network.Services
{
    ...
    /// <summary>
    /// class responsible for getting the LTE files off of the sprint server via SFTP
    /// </summary>
    public class LTESftpMgr
    {
        private string m_eventLogName = System.Configuration.ConfigurationManager.AppSettings["SftpLTEHandlerEventLogName"];
        private string m_logFile = System.Configuration.ConfigurationManager.AppSettings["SftpLTEHandlerLogFileName"];
