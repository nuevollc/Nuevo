...
namespace Strata8.Telephony.MiddleTier.Services.CDR
{
    ...
    public class BworksCdr
    {
        ...
        public string department; // 32 = 33 -1
        public string originalCalledNumber; // 35 (zero index)   
        public string originalCalledReason; // 37  
        public string redirectingNumber;    // 38  
        public string redirectingReason;    // 40  
