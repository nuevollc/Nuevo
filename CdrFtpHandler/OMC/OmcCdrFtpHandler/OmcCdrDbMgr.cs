       ...
       public bool CheckDbBeforeDownloadingFile(string fileName)
        {
            ...
            StringBuilder cmdStr = new StringBuilder("SELECT fileName from OmcCdrFileToLogi where fileName =");
            ...
            {
                FileWriter.Instance.WriteToLogFile("OmcCdrDbMgr::CheckDbBeforeDownloadingFile():FailedTryingGetTheFileNameInTheDB");
        ...
        public void UpdateFtpFileNameInDb(string fileName)
        {
            ...
            try
            {
                ...
                {
                    dataConnection.Open();
                    StringBuilder cmdStr = new StringBuilder("INSERT INTO OmcCdrFileToLogi ");
            ...
            {
                FileWriter.Instance.WriteToLogFile("OmcCdrDbMgr::UpdateFtpFileNameInDb():FailedTryingToUpdateTheFileNameInTheDB");
                FileWriter.Instance.WriteToLogFile("ECaught:" + e.Message + e.StackTrace);
            }
