...
namespace Omc.Cdr.Ftp
{
    public class OmcCdrFtpHandler
    {
        ...
        public void StartProcessing()
        {
            ...
            FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::StartProcessing():StartingThread");
            m_procThread.Start();
            FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::StartProcessing():ThreadStarted");
        ...
        public void ProcessFileControlThread()
        {
            ...
            while (true)
            {
                try
                {
...

                    {
                        try
                        {
                                    ...
                                    if (!_dbMgr.CheckDbBeforeDownloadingFile(fi.Name))
                                    {
                                        try
                                        {
                                            ...
                                            if (ftp.FileExists(fil))  /* check that a file exists */
                                            {
                                                ...
                                                FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::ProcessFileControlThread:DownloadedFile" + fi.Name);
                                        ...
                                        {
                                            FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::ProcessControlThread:EXCEPTIONCAUGHT(Open/Login/Directory)::" + se.Message);
                            ...
                            {
                                FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::ProcessFileControlThread:GetFilesChoke" + fe.Message );
                        ...
                        {
                            FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::ProcessFileControlThread:EXCEPTIONCAUGHT::" + se.Message);
                ...
                catch (SystemException se)
                {
                    ...
                    FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::ProcessFileControlThread:EXCEPTIONCAUGHT::TryingToConnect" + se.Message);
        ...
        public void StopProcessing()
        {
            ...
            FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::StopProcessing::");
        ...
        private void InitializeFromConfig()
        {
            try
            {
                ...
                {
                    FileWriter.Instance.WriteToLogFile("OmcCdrFtpHandler::InitializeFromConfig::" + ex.Message + ex.StackTrace);
                }
